This repository contains the code to accompany the manuscript **"Mutation rates and fitness consequences of mosaic chromosomal alterations in blood"**. Code was written using Python. 
...
Note on data files:  Participant-level data files previously included in this repository have been removed in compliance with UK Biobank's terms of data access.  The analysis code remains complete.  Data access can be applied for directly through the UK Biobank Access Management System (https://www.ukbiobank.ac.uk/enable-your-research/apply-for-access).
...
## LICENSE
[GNU General Public License v3.0](https://choosealicense.com/licenses/gpl-3.0/)# mCA-mutation-rates-fitness-consequences
